...
A screencast of an experimental GUI is available for download [here](http://annis.ling.uni-potsdam.de/gsdp_gui_demo.mp4). The user-specified input text is processed and connective (yellow) and argument (green and blue) tokens are highlighted according to parser output.  
